...
// RealConsole.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CRealConsoleApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CRealConsoleApp

CRealConsoleApp::CRealConsoleApp()
{
...
// Único objeto CRealConsoleApp

CRealConsoleApp theApp;


// Inicialización de CRealConsoleApp

BOOL CRealConsoleApp::InitInstance()
{
